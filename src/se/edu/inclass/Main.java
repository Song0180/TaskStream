...
public class Main {
    ...
    private static int countDeadlinesWithStreams(ArrayList<Task> taskData) {
    ...
    public static ArrayList<Task> filterTasksByString(ArrayList<Task> taskData, String filterString) {
